...
OUTPUT_PATH = './models/WBC_1_fineTune'
...
class ViTForImageClassificationFromMAE(nn.Module):
    ...
    def __init__(self, pretrained_model_path, num_labels=5):
        super(ViTForImageClassificationFromMAE, self).__init__()
...
model = ViTForImageClassificationFromMAE(MODEL_PATH, num_labels=5)

# model = ViTForImageClassificationFromMAE(MODEL_PATH, config)
