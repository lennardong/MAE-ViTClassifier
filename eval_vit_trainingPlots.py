...
if __name__ == '__main__':
    ...
    PLOTS_FROMSCRATCH = {
        'WBC1, \n(From Scratch)': 'models/fromScratch_WBC_1/',
        'WBC10, \n(From Scratch)': 'models/fromScratch_WBC_10/',
        'WBC50, \n(From Scratch)': 'models/fromScratch_WBC_50/',
        'WBC100, \n(From Scratch)': 'models/fromScratch_WBC_100/',
    }
    for tag, folder in PLOTS_FROMSCRATCH.items():
        title = f"Training Plots for {tag}"
        plot_training(folder, title)

    # Plot Transfer Learning Models
    PLOTS_TRANSFERLEARNING = {
        'WBC1, \n(Transfer Learning)': 'models/transfer_WBC_1/',
        'WBC10, \n(Transfer Learning)': 'models/transfer_WBC_10/',
        'WBC50, \n(Transfer Learning)': 'models/transfer_WBC_50/',
        'WBC100, \n(Transfer Learning)': 'models/transfer_WBC_100/',
    }
    for tag, folder in PLOTS_TRANSFERLEARNING.items():
        title = f"Training Plots for {tag}"
        plot_training(folder, title)
